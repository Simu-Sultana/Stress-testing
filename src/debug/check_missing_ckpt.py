...
#
# Example:
#   mimic_iii_subsampled_70_5/best.pt
# =========================================================
        ...
        for perturbation in PERTURBATIONS:
            for pct in PCTS:
                for seed in SEEDS:
                    ...
                    item = (dataset, TARGET, model, perturbation, pct, seed, ckpt_path)
...
for dataset, target, model, perturbation, pct, seed, ckpt_path in missing:
...
out_file = RESULTS_ROOT / "missing_bestpt_report.txt"
...
with open(out_file, "w") as f:
    ...
    for dataset, target, model, perturbation, pct, seed, ckpt_path in missing:
        f.write(
            ...
            f"pct={pct} | seed={seed} | expected={ckpt_path}\n"
        )
