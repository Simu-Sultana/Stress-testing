...
parser.add_argument("--ratio", type=float, required=True, help="Fraction of train+val to keep, e.g., 0.9")
...
ts_sub = ts.sample(frac=r, random_state=args.seed)
...
# save
out_path = os.path.join(OUT_DIR, f"physionet_sparsified_{pct}_{args.seed}.pkl")
