...
parser = argparse.ArgumentParser(
    description="PhysioNet-2012 sparsification grouped by (ts_id, variable) with CSV logging"
)
parser.add_argument("--data_dir", type=str, required=True, help="Path to folder containing physionet_2012.pkl")
...
# 3. Load dataset
# --------------------------------------------------------
in_path = os.path.join(RAW_DATA_PATH, "physionet_2012.pkl")
...
# group by both admission (ts_id) AND variable
...
csv_path = os.path.join(
    OUT_DIR,
    f"physionet_2012_patient-variable_stats_{args.pct}_{args.seed}.csv"
)
...
out_path = os.path.join(
    OUT_DIR,
    f"physionet_2012_sparsified-tsid-varid_{args.pct}_{args.seed}.pkl"
)
